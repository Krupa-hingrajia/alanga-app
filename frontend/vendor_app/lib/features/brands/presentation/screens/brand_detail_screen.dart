...
class BrandDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final statusColor = _getStatusColor(brand.status);
    final canEdit = brand.status.toUpperCase() == 'PENDING' ||
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildMetaRow(
                    ...
                    label: 'Last Updated',
                    value: _formatDate(brand.updatedAt),
                  ),
                ],
              ),
            ),
            ...
            if (brand.status.toUpperCase() == 'REJECTED' &&
                brand.rejectedReason != null &&
                brand.rejectedReason!.isNotEmpty)
              Container(
                padding: const EdgeInsets.all(20),
                decoration: BoxDecoration(
